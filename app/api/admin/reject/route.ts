...
export async function POST(request: Request) {
  ...
  // Remove approved tag if present, then add rejected
  await cloudinary.uploader.remove_tag("approved", [publicId]).catch(() => null);
  await cloudinary.uploader.add_tag("rejected", [publicId]);
